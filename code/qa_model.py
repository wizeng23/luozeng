...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        blended_reps_final = tf.contrib.layers.fully_connected(blended_reps, num_outputs=self.FLAGS.hidden_size*4) # blended_reps_final is shape (batch_size, context_len, hidden_size*4)
